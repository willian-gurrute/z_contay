...
<div class="main-container">
    ...
    <main class="content-area">
        ...
        <p class="subtitulo">
            Modifica la información del negocio que se mostrará en documentos y facturas del sistema.
        </p>
        ...
        <form class="form-ajustes" method="POST" action="../backend/administrador/actualizar_ajustes_generales.php">
